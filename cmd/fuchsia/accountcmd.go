...
var (
	walletCommand = cli.Command{
		...
		Description: `
    fuchsia wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	fuchsia wallet [options] /path/to/my/presale.wallet
...
`,
			},
			{
				...
				Description: `
    fuchsia account update <address>
...
For non-interactive use the password can be specified with the --password flag:
    ...
    fuchsia account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    fuchsia account import <keyfile>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    fuchsia account import [options] <keyfile>
