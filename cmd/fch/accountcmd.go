...
var (
	walletCommand = cli.Command{
		...
		Description: `
    FCH wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	FCH wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the password can be specified with the --password flag:
    ...
    FCH account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    FCH account import [options] <keyfile>
